...
const (
	...
	UserService_PaginateUsers_FullMethodName = "/user.UserService/PaginateUsers"
)
...
func (c *userServiceClient) PaginateUsers(ctx context.Context, in *PaginateRequest, opts ...grpc.CallOption) (*PaginateUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaginateUsersResponse)
	err := c.cc.Invoke(ctx, UserService_PaginateUsers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) PaginateUsers(context.Context, *PaginateRequest) (*PaginateUsersResponse, error) {
...
func _UserService_PaginateUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_PaginateUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).PaginateUsers(ctx, req.(*PaginateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
